...
{
    public function create(array $data, iterable $cartItems, float|int $cartTax, float|int $cartDiscount): SaleReturn
    {
    ...
    public function update(SaleReturn $saleReturn, array $data, iterable $cartItems, float|int $cartTax, float|int $cartDiscount): SaleReturn
    {
        return DB::transaction(function () use ($saleReturn, $data, $cartItems, $cartTax, $cartDiscount): SaleReturn {
            $dueAmount = $data['total_amount'] - $data['paid_amount'];
